...
namespace AntChain\AICOADVISORMARKET;
...
class Client {
     ...
     * Summary: 客户统计结果查询
     * @param QueryAitechCommAdvisormarketDataRequest $request
     * @return QueryAitechCommAdvisormarketDataResponse
     */
    public function queryAitechCommAdvisormarketData($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryAitechCommAdvisormarketDataEx($request, $headers, $runtime);
    }
